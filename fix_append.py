...
truncated_at = content.find('hover:bg-gray-100 rounded"')
if truncated_at == -1:
    truncated_at = content.find('hover:bg-gray-1')

if truncated_at != -1:
    content = content[:truncated_at]

end_content = '''hover:bg-gray-100 rounded">
              格式 ▾
            </button>
...
full_content = content + end_content

tmp_file = '/Volumes/Work-Project/SnapSheet/src/pages/Home.tsx.tmp'
with open(tmp_file, 'w') as f:
    f.write(full_content)

import os
os.replace(tmp_file, '/Volumes/Work-Project/SnapSheet/src/pages/Home.tsx')
